...
var Session = (function () {
    function Session(_a) {
        ...
        this.expired = new Date(expired ? expired : Date.now() + config_1.PER_SESSION);
    ...
    Session.prototype.restart = function () {
        this.expired = new Date(Date.now() + config_1.PER_SESSION);
        this.total_action = 0;
        this.read_count = 0;
    ...
    Session.prototype.canReadArticle = function () {
        return this.read_count < config_1.MAX_READ_COUNT;
    };
    ...
    Object.defineProperty(Session.prototype, "exceedTotalAction", {
        get: function () {
            return this.total_action > config_1.MAX_TOTAL_ACTION;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Session.prototype, "exceedCharacterCount", {
        get: function () {
            return this.character_count > config_1.MAX_CHARACTER_COUNT;
        },
        enumerable: false,
        configurable: true
    });
